    ...
    return (React.createElement("div", { className: "login" },
        React.createElement("div", { className: "login__wrapper" },
            React.createElement("div", { className: "login__wrappper_top" },
                ...
                React.createElement(InputAuth, { placeholder: "Email", value: email, setValue: (e) => setEmail(e), type: "email" }),
                React.createElement(InputAuth, { placeholder: "Password", value: password, setValue: (e) => setPassword(e), type: "password" }),

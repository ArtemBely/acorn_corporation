  ...
  return (
    <div className="privacy">
      <div className="privacy__wrapper">
        <div className="privacy__wrapper-header">
          <Heading>Privacy</Heading>
          <Close />
        </div>
        <div className="privacy__body">
          <p className="privacy__body-title">
            Политика в отношении обработки персональных данных
          </p>
          {/* items */}
          <div className="privacy__body-items">
            <div className="privacy__body-item">
              <p className="privacy__body-item-title">1. Общие положения</p>
              <p className="privacy__body-item-text">
                ...
                предпринимаемые ИП Поветьевым Кириллом Владимировичем (далее —
                Оператор).
                <br />
                <br />
                ...
                веб-сайта https://acorn.ws.
              </p>
            </div>
            <div className="privacy__body-item">
              <p className="privacy__body-item-title">
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                действия или бездействие Оператора при обработке
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                <br />
                <br />
                5.7. Обработка персональных данных, разрешённых
                ...
                соблюдаются условия, предусмотренные, в частности,
                ст. 10.1 Закона о персональных данных. Требования к содержанию
                такого согласия устанавливаются уполномоченным органом по защите
                прав субъектов персональных данных.
                <br />
                <br />
                5.8.1 Согласие на обработку персональных данных, разрешённых
                для распространения, Пользователь предоставляет Оператору
                непосредственно.
                <br />
                <br />
                5.8.2 Оператор обязан в срок не позднее трёх рабочих дней
                с момента получения указанного согласия Пользователя
                опубликовать информацию об условиях обработки, о наличии
                запретов и условий на обработку неограниченным кругом
                лиц персональных данных, разрешённых для распространения.
                <br />
                <br />
                ...
                <br />
                <br />
                5.8.4 Согласие на обработку персональных данных, разрешённых
                для распространения, прекращает своё действие с момента
                поступления Оператору требования, указанного в п.
                5.8.3 настоящей Политики в отношении обработки персональных
                данных.
              </p>
            </div>
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                договором, стороной которого, выгодоприобретателем
                или поручителем по которому является субъект персональных
                данных. Обрабатываемые персональные данные уничтожаются
                либо обезличиваются по достижении целей обработки или в случае
                утраты необходимости в достижении этих целей, если иное
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                и/или материалам, содержащимся на веб-сайте https://acorn.ws.
                <br />
                <br />
                ...
                Оператору письмо на адрес электронной почты privacy@acorn.ws
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                на обработку персональных данных, разрешённых
                для распространения.
                <br />
                <br />
                ...
                https://acorn.ws или направленные Оператору посредством
                ...
                решение о предоставлении его персональных данных и даёт согласие
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                прав и законных интересов оператора или третьих
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                Оператора privacy@acorn.ws с пометкой «Актуализация персональных
                данных».
                <br />
                <br />
                ...
                своё согласие на обработку персональных данных, направив
                Оператору уведомление посредством электронной почты
                на электронный адрес Оператора privacy@acorn.ws с пометкой
                ...
                ознакомиться с указанными документами. Оператор не несёт
                ...
                данных, разрешённых для распространения, не действуют в случаях
                обработки персональных данных в государственных, общественных
                и иных публичных интересах, определённых законодательством РФ.
                <br />
                <br />
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                передачу персональных данных, обеспечивается надёжная защита
                прав субъектов персональных данных.
                <br />
                <br />
            ...
            <div className="privacy__body-item">
              ...
              <p className="privacy__body-item-text">
                ...
                <a href="https://acorn.ws/privacy" style={{ color: "#8e8e8e" }}>
                  https://acorn.ws/privacy
                </a>
                .
              </p>
            </div>
